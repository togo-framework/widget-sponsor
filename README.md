...
<div align="center">
  ...
  <h1>togo-framework/widget-sponsor</h1>
  <p>
    <a href="https://to-go.dev/marketplace"><img src="https://img.shields.io/badge/marketplace-to--go.dev-1FC7DC" alt="marketplace" /></a>
    <a href="https://pkg.go.dev/github.com/togo-framework/widget-sponsor"><img src="https://pkg.go.dev/badge/github.com/togo-framework/widget-sponsor.svg" alt="pkg.go.dev" /></a>
...
```bash
togo install togo-framework/widget-sponsor
```
...
Support CTA with GitHub Sponsors + Buy-me-a-coffee and perks.
